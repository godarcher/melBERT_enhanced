...
SYSTEM_DESCRIPTION = "MetRobert is a metaphor detection model for Dutch it is developed by Joost Grunwald at the Radboud University Nijmegen. It will automaticly try to label metaphors in texts. You can upload either tokenised or untokenised files (which will be automatically tokenised for you using ucto), the output will consist of a zip file containing XML files, one for each sentence in the input document."
